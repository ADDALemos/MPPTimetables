...
#ifndef TIMETABLER_DISTRIBUTIONPENALTY_H
#define TIMETABLER_DISTRIBUTIONPENALTY_H
...
public:
    DistributionPenalty(Constraint *pLimit, std::vector<int> classes, int penalty) :
